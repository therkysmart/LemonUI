...
#elif FIVEM_MONOV2
                OutString raw = Natives.GetScaleformMovieMethodReturnValueString(id);
...
#elif FIVEM_MONOV2
        public async Coroutine<T> CallFunction<T>(string function, params object[] parameters)
#else
...
#elif FIVEM_MONOV2
                await BaseScript.WaitUntilNextFrame();
#elif SHVDN3 || SHVDNC
                Script.Yield();
#endif
            }
